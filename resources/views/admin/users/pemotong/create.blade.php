                                    ...
                                    <div class="col-lg-8">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="name" class="form-control"
                                                placeholder="Nama Pemotong" value="{{ old('name') }}" required>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-8">
                                        <div class="input-group">
                                            ...
                                            <input type="email" name="email" class="form-control"
                                                placeholder="Email Pemotong" value="{{ old('email') }}" required>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-8">
                                        <div class="input-group">
                                            ...
                                            <input type="password" name="password" class="form-control"
                                                id="password-input" placeholder="Password Pemotong" required>
