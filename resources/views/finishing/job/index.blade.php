        ...
        <div class="page-header">
            <div class="page-header-left d-flex align-items-center">
                <div class="page-header-title">
                    <h5 class="m-b-10">Job Finishing & Packing</h5>
                </div>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item">Finishing</li>
                    <li class="breadcrumb-item active">Job Finishing</li>
                </ul>
            </div>
        </div>
                ...
                <div class="col-xxl-12">
                    <div class="card stretch stretch-full">
                        ...
                        <div class="card-header">
                            <h5 class="card-title">Daftar Job Siap Finishing</h5>
                        </div>
                        ...
                        <div class="card-body custom-card-action p-0">
                            ...
                            <div class="table-responsive">
                                <table id="datatable-model" class="table table-hover align-middle mb-0">
                                    ...
                                    @include('finishing.partials.table-body')
        ...
        <div class="modal-content">
            <form id="formKerjakan" enctype="multipart/form-data">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Kerjakan Job Finishing</h5>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('formKerjakan').addEventListener('submit', function(e) {
            ...
            fetch(`/finishing/job-finishing/${id}/selesai`, {
                    method: 'POST',
                    headers: {
        ...
        // ===============================
        function loadTable() {
            fetch("{{ route('finishing.job.table') }}")
                .then(res => res.text())
                .then(html => {
