        ...
        <div class="page-header">
            <div class="page-header-left d-flex align-items-center">
                <div class="page-header-title">
                    <h5 class="m-b-10">Riwayat Job Finishing</h5>
                </div>
                <ul class="breadcrumb">
                ...
                <div class="col-xxl-12">
                    <div class="card stretch stretch-full">
                        ...
                        <div class="card-header">
                            <h5 class="card-title">Riwayat Job Finishing & Packing</h5>
                        </div>
                                ...
                                <table id="datatable-model"
                                    ...
                                    <tbody>
                                        @forelse ($jobs as $job)
                                            <tr>
                                                <td>
                                                    {{ $job->jobProduksi->modelPakaian->nama_model }}
                                                </td>
                                                <td>
                                                    {{ $job->jobProduksi->jumlah_target }}
                                                </td>
                                                <td>
