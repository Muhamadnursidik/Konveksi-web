            ...
            <div class="page-header-left d-flex align-items-center">
                ...
                <ul class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="{{ route('finishing.profile') }}">Finishing</a>
                    </li>
                ...
                <div class="col-lg-12">
                    <div class="card stretch stretch-full">
                        ...
                        <div class="card-header">
                            <h5 class="card-title">Edit Akun Finishing</h5>
                        </div>

                        <form action="{{ route('finishing.profile.update', $users->id) }}" method="POST"
                            ...
                            <div class="card-footer d-flex justify-content-end gap-2">
                                <a href="{{ route('finishing.profile') }}" class="btn btn-light">
                                    Kembali
                                </a>
